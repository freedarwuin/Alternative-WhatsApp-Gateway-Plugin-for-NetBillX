...
<div class="bs-callout bs-callout-info" id="wga-callout-api">
    ...
    <p class="text-muted"><small>{Lang::T('Copy the API URL and paste it in SMS Server URL field in SMS')}
            Settings.</small></p>
    <p class="text-muted">{Lang::T('If you update the API Token in')} <a href="{$_url}settings/app">Settings > {Lang::T('General Settings')} > API
